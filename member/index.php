...
<body>
  ...
  include 'connection.php';
                    ...
                    @$sql = "SELECT count(reg_number) FROM member where team_id='$id'";
                    $result = $conn->query($sql);
                    ...
                    $sql = "SELECT count(p_id) FROM project where status='unsigned' and team_id='id'";
                    $result = $conn->query($sql);
                    ...
                    @$sql = "SELECT count(p_id) FROM project where team_id='id'";
                    $result = $conn->query($sql);
