                ...
                <div class="card-body">
                  ...
                  <form class="row g-3 needs-validation" action='users_login.php' method='POST' novalidate>
                    ...
                    <div class="col-12">
                      ...
                      <div class="input-group has-validation">
                        <span class="input-group-text" id="inputGroupPrepend"><i class="fa fa-key"></i></i></span>
...
if(isset($login))
{
      ...
      elseif($user==='leader')
        ...
        
        {
          ...
          $sql = "SELECT * FROM member WHERE m_email='$email' AND password='$pass'";
          $result = mysqli_query($conn, $sql);
          if (mysqli_num_rows($result) == 1)
              {

                $sql1 = "SELECT team_id,m_fname,reg_number FROM member WHERE m_email='$email' AND password='$pass'";
