        ...
        <div class="col-xl-8">
          ...
          <div class="card">
            ...
            <br>
                  ...
                  <!-- Profile Edit Form -->
                  <form action='users-profile.php' method='POST' novalidate enctype="multipart/form-data">
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <input name="phone" type="number" maxlength="10" max='10' class="form-control" id="Linkedin" value="<?php echo $row['phone'] ?>">
                      </div>
                    </div>
