...
<body>
  ...
  <aside id="L_sidebar" class="sidebar">
    <?php
    ...
    <section class="section">
      ...
      <?php
                    ...
                    if ($result->num_rows > 0) {
                      ...
                      <div class="pagetitle">
      <h1>TEAM MATE IDENTIFICATIONS</h1>
      <nav>
        <ol class="breadcrumb">
          ...
          <!-- <li class="breadcrumb-item active">Blank</li> -->
                      ...
                      <div class="card" style='padding:0.7cm'>
                        <img src="../member/assets/img/profile/<?php echo $row['profile'] ?>" class="card-img-top" alt="...">
                       <br>
                        <div class="card-body">
                          ...
                          <h5 class="">GitHub: <?php  echo $row['git'] ?></h5>
